...
const tealBorderDim = "rgba(0,212,170,0.12)";
const cardBg = "#0A0A12";
const textMuted = "#8A8A9A";
const textBody = "#E8E6F0";
  ...
  return (
    <div style={{ overflowX: "hidden" }}>
      ...
      <div style={{
        ...
        <FadeIn>
          <div style={{
            ...
            fontSize: 11, letterSpacing: "0.14em", color: teal,
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ height: 1, background: `linear-gradient(90deg, transparent, ${tealBorder}, transparent)` }} />
      </div>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", flexShrink: 0 }}>
                <div style={{
                  ...
                  fontSize: 11, color: teal, fontWeight: 700, letterSpacing: "0.04em",
                ...
                {i < milestones.length - 1 && (
                  <div style={{
                    ...
                    background: `linear-gradient(180deg, ${tealBorder}, transparent)`,
                    marginTop: 8,
                  }} />
                )}
              </div>
              ...
              <div style={{ paddingTop: 8 }}>
                <div style={{
                  fontSize: 11, letterSpacing: "0.12em", color: teal,
        ...
        <div style={{
          ...
          {values.map((v, i) => (
            <FadeIn key={i} delay={i * 0.08}>
              <div style={{
                background: cardBg,
                border: `1px solid ${tealBorderDim}`,
                ...
                onMouseLeave={e => {
                  e.currentTarget.style.borderColor = tealBorderDim;
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a
              ...
              style={{
                ...
                border: `1px solid ${tealBorder}`,
                color: textBody, padding: "14px 32px",
