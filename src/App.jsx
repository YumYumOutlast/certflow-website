        ...
        <div style={{ display: "flex", gap: 28, alignItems: "center" }}>
          {[["how", "How It Works"], ["why", "Why CertFlow"], ["faq", "FAQ"], ["contact", "Contact"]].map(([id, label]) => (
            <button key={id} onClick={() => scrollTo(id)} style={{
              background: "none", border: "none", color: active === id ? "#E8A020" : "#8a8a9a",
  ...
  return (
    <section id="hero" style={{
      ...
      <div style={{ textAlign: "center", maxWidth: 750, padding: "0 24px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          marginTop: 60, display: "flex", justifyContent: "center", gap: 48, flexWrap: "wrap",
        }}>
          {[
            ["< 5 min", "Average turnaround"],
            ["15+", "Edge cases trained"],
            ["10+", "Carriers mapped"],
          ].map(([num, label]) => (
...
function HowItWorks() {
  ...
  return (
    <section id="how" style={{
      padding: "120px 24px", background: "#060A12",
      borderTop: "1px solid rgba(232,160,32,0.06)",
    }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 24 }}>
          {steps.map((s) => (
            <div key={s.num} style={{
              ...
              <div style={{
                fontSize: 13, color: "#8a8a9a", lineHeight: 1.7,
...
function WhyCertFlow() {
  ...
  return (
    <section id="why" style={{
      padding: "120px 24px",
      background: "radial-gradient(ellipse at 50% 0%, rgba(232,160,32,0.04) 0%, transparent 60%), #060A12",
      borderTop: "1px solid rgba(232,160,32,0.06)",
    }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          <h2 style={{
            fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 800,
            fontFamily: "'Playfair Display', Georgia, serif",
            color: "#f0e8d8", margin: "0 0 16px 0",
          }}>Not another generic AI tool.</h2>
          <p style={{
            fontSize: 16, color: "#8a8a9a", fontFamily: "'DM Sans', sans-serif",
            maxWidth: 500, margin: "0 auto", lineHeight: 1.7,
          }}>Built by someone from the trucking industry who learned insurance from the inside out.</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
          {features.map((f) => (
            <div key={f.title} style={{
              ...
              <div style={{
                fontSize: 15, fontWeight: 700, color: f.color,
...
function FAQ() {
  ...
  const faqs = [
    ...
    { q: "Does CertFlow replace our agency management system?", a: "No. CertFlow works alongside your existing AMS (Applied Epic, HawkSoft, AMS360, etc.). We handle the intake and data extraction — reading the email, identifying fields, validating endorsements. The clean, validated data then feeds into your existing workflow. We're the brain between the email and the form." },
    { q: "Is CertFlow acting as an insurance agent or broker?", a: "No. CertFlow provides administrative and clerical data processing services only. We do not bind coverage, make coverage recommendations, or act as a producer on any certificate. Your agency retains full authority and responsibility for all certificates issued." },
    { q: "What endorsements and edge cases does it handle?", a: "CertFlow is trained on 15+ real-world trucking COI edge cases including additional insured (CG 20 01, CG 20 10), primary and non-contributory (CG 20 37), waiver of subrogation (CG 24 04 for GL, CA 04 44 for auto), MCS-90, loss payee vs additional insured, batch requests, umbrella follow-form issues, auto symbol codes, and more. It also has carrier-specific intelligence for Progressive, Canal, Northland, Great West Casualty, CNA, and others." },
    { q: "What if the CSR sends a messy or incomplete email?", a: "CertFlow is designed to read real CSR language — shorthand, abbreviations, typos, and all. If critical information is missing, the system flags it for review and can prompt the CSR for the missing fields rather than generating an incorrect certificate." },
    { q: "How much does it cost?", a: "CertFlow is a flat monthly fee per agency. No per-certificate charges, no setup fees, month-to-month. Contact us for current pricing." },
    { q: "How long does implementation take?", a: "Most agencies are up and running within a week. Your CSRs don't need training — they just email requests the way they always have. We handle the setup and configuration on our end." },
    { q: "What about data security and confidentiality?", a: "All data is processed securely and never shared with third parties. We sign a Master Service Agreement and Data Processing Agreement with every client. Your policyholder data stays confidential." },
  ];
          ...
          {faqs.map((f, i) => (
            <div key={i} onClick={() => setOpen(open === i ? null : i)} style={{
              ...
              <div style={{
                ...
                <div style={{
                  fontSize: 14, fontWeight: 600, color: open === i ? "#E8A020" : "#c8c0b0",
                  fontFamily: "'DM Sans', sans-serif",
                }}>{f.q}</div>
                <div style={{
                  fontSize: 18, color: "#E8A020", transform: open === i ? "rotate(45deg)" : "rotate(0deg)",
                  transition: "transform 0.2s", flexShrink: 0, marginLeft: 12,
                }}>+</div>
              </div>
              {open === i && (
                <div style={{
                  fontSize: 13, color: "#8a8a9a", lineHeight: 1.8,
                  fontFamily: "'DM Sans', sans-serif",
...
function Contact() {
  ...
  return (
    <section id="contact" style={{
      padding: "120px 24px",
      background: "radial-gradient(ellipse at 50% 100%, rgba(232,160,32,0.06) 0%, transparent 60%), #060A12",
      borderTop: "1px solid rgba(232,160,32,0.06)",
    }}>
      <div style={{ maxWidth: 550, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{
            fontSize: 15, color: "#8a8a9a", fontFamily: "'DM Sans', sans-serif", lineHeight: 1.7,
          }}>Request a 5-minute live demo. We'll process a COI request in real time while you watch.</p>
        </div>
        {!sent ? (
          <div style={{
            background: "rgba(255,255,255,0.02)",
            ...
            {[
              { key: "name", label: "Your Name", placeholder: "Dylan Brown" },
              { key: "email", label: "Email", placeholder: "you@agency.com" },
              { key: "agency", label: "Agency Name (optional)", placeholder: "Smith Insurance Agency" },
            ].map((f) => (
              <div key={f.key} style={{ marginBottom: 18 }}>
                <label style={{
                  display: "block", fontSize: 11, color: "#E8A020",
                ...
                <input
                  ...
                  style={{
                    width: "100%", background: "rgba(232,160,32,0.04)",
                    border: "1px solid rgba(232,160,32,0.15)",
                    borderRadius: 8, padding: "12px 14px",
                    color: "#e0d8c8", fontSize: 14,
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <textarea
                ...
                placeholder="Tell us about your agency and how you currently process COIs"
                rows={3}
                style={{
                  width: "100%", background: "rgba(232,160,32,0.04)",
                  border: "1px solid rgba(232,160,32,0.15)",
            ...
            <button onClick={handleSubmit} style={{
              ...
              borderRadius: 10,
              background: form.name && form.email ? "linear-gradient(135deg, #B8860B, #E8A020)" : "rgba(255,255,255,0.05)",
              border: "none",
              color: form.name && form.email ? "#060A12" : "#556",
          ...
          <div style={{
            ...
            <div style={{
              fontSize: 18, fontWeight: 700, color: "#1A8A4A",
              fontFamily: "'Playfair Display', Georgia, serif", marginBottom: 8,
            }}>Demo Requested</div>
            <div style={{
              fontSize: 13, color: "#8a8a9a",
              fontFamily: "'DM Sans', sans-serif",
            }}>We'll be in touch within 24 hours to schedule your live demo.</div>
          </div>
        )}
      </div>
    </section>
    ...
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          fontFamily: "'DM Sans', sans-serif",
        }}>CertFlow Administrative Services LLC &middot; Administrative COI Processing</div>
        <div style={{
          fontSize: 11, color: "#445",
          fontFamily: "'DM Sans', sans-serif",
        }}>&copy; 2026 CertFlow. All rights reserved.</div>
      </div>
    </footer>
  );
}
